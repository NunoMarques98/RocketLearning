...
/**
 * Generated class for the ConditionalsPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
...
var TypesPage = /** @class */ (function () {
    ...
    TypesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-types',template:/*ion-inline-start:"C:\Users\nuno1\OneDrive\Documentos\Estudar\3º ano\1º Semestre\PCM\trabalhos\rocket\src\pages\types\types.html"*/'<!--\n  Generated template for the TypesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n<ion-content padding>\n  <ion-row>\n    <ion-col col-12>\n        <h1>2. Tipos</h1>\n    </ion-col>\n  </ion-row>\n  <ion-grid>\n    <ion-row justify-content-center align-items-center>\n      <ion-col col-12>\n        <pre>\n          <p>\n            Antes de passarmos às operações que se podem fazer com as variáveis que aprendemos no capitulo anterior, precisamos \n            de esclarecer o conceito de tipos de variável. Os tipos permitem-nos distinguir variáveis e as operações que se podem \n            realizar sobre elas. Isto é, as operações que podemos fazer com \n            <code class="javascript hljs">var x = 1;</code>\n            que é um Number, são diferentes das operações que se fazem com\n            <code class="javascript hljs">var x = \'1\';</code> \n            que é uma String.\n          </p>\n          <p>\n            Posto isto, podemos distinguir os seguintes tipos de variáveis:\n            <code class="javascript hljs">\n              var x = 1;\n              var y = 1.2;\n              var z = -1;\n              var w = -1.2;\n\n              var t = 2e5; // Notação científica\n            </code>\n            Aqui as variáveis x, y, z e w são do tipo <strong>Number</strong>. O tipo <strong>Number</strong> engloda todos os tipos numéricos, ou seja, todos os números\n            inteiros e reais, positivos ou negativos.\n            <br>\n\n            <code class="javascript hljs">\n                var x = \'Isto é uma string\';\n                var y = \'a\';\n                var z = \'\';\n            </code>\n\n            As variáveis x, y e z são <strong>String</strong>, isto é, são aquilo a que chamamos texto. Uma <strong>String</strong> pode ser um conjunto de \n            vários caracteres, um único caracter ou até mesmo vazia.\n            <br>\n\n            <code class="javascript hljs">\n                var x = true;\n                var y = false;\n            </code>\n\n            As variáveis x e y são do tipo <strong>Boolean</strong>, ou seja, têm um valor de verdade ( true ou false ) associado. Este tipo \n            de variáveis é principalmente em decisão condicional, como veremos mais à frente.\n            <br>\n\n            <code class="javascript hljs">\n              var x;\n            </code>\n\n            Neste caso, a variável x tem tipo <strong>Undefined</strong>, trocando por miúdos, a variável x existe mas não tem valor associado.\n            Mais simples ainda, existe uma caixa com o nome x mas não tem nada guardado.\n            <br>\n\n            <code class="javascript hljs">\n              var x = "E-Learning javascript";\n              x = null;\n            </code>\n\n            O tipo <strong>Null</strong> indica que a variável não existe, posto de outra forma, <strong>Null</strong> designa o vazio e não existência. Conforme \n            está escrito acima, podemos fazer com que uma variável deixe de existir atribuindo-lhe o valor null.\n            <br>\n\n            <code class="javascript hljs">\n              var carro = {{\'{\'}} portas: 5, lugares: 5, velocidade_máxima: 200, matricula: \'AB-12-CD\' {{\'}\'}};\n            </code>\n\n            Há ainda mais um tipo, o tipo <strong>Object</strong>, que server para representar, como o nome indica, objectos do mundo real.\n            Não te preocupes se não percebeste o que isto significa, os objectos terão um capitulo específico. Por agora fica \n            com esta definição.\n            <br>\n\n            Como podes ver, pelo exemplo do tipo <strong>Null</strong>, os tipos em JavaScript são dinâmicos, uma variável\n            num dado instante tem um tipo mas pode ser modificado.\n\n            <code class="javascript hljs">\n                var x = 10; // x é um Number\n                x = \'Tipo String\'; // x é uma String\n            </code>\n            <br>\n\n            Para verificarmos o tipo de uma variável, é aconselhável usar a função <strong>typeof</strong>() como segue.\n\n            <code class="javascript hljs">\n                var x = 10; // x é um Number\n                console.log(typeof(x)); // Number\n\n                var y = \'Dezembro\';\n                console.log(typeof(y)); // String\n\n                var z = true;\n                console.log(typeof(z)); // Boolean\n            </code>\n          </p>\n      </pre>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\Users\nuno1\OneDrive\Documentos\Estudar\3º ano\1º Semestre\PCM\trabalhos\rocket\src\pages\types\types.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
    ], TypesPage);
    return TypesPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vars_vars__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__classes_classes__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__conditionals_conditionals__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__functions_functions__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__loops_loops__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__objects_objects__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__operators_operators__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__types_types__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_vars_vars__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_classes_classes__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_conditionals_conditionals__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_functions_functions__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_loops_loops__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_objects_objects__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_operators_operators__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_types_types__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
